...
import cc.ddrpa.repack.safebox.type.SecureString;
...
@MappedJdbcTypes({JdbcType.CHAR, JdbcType.VARCHAR, JdbcType.NCHAR, JdbcType.NVARCHAR, JdbcType.LONGVARCHAR, JdbcType.LONGNVARCHAR})
public final class SecureStringTypeHandler extends AbstractSecureTypeHandler<SecureBytes> {
    @Override
